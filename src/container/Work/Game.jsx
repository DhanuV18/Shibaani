      ...
      >
          ...
          <div className="app__work-item app__flex" key="RockScissorPaper">
            ...
            >
              ...
              >
                <a href='https://ssurudisya.github.io/Rock-Paper-Scissor_Game/' target="_blank" rel="noreferrer">
                ...
                <a href='https://github.com/SSurudisya/Rock-Paper-Scissor_Game.git' target="_blank" rel="noreferrer" className='language'>
                  <motion.div
                    whileInView={{ scale: [0, 1] }}
                    whileHover={{ scale: [1, 0.90] }}
                    transition={{ duration: 0.25 }}
            ...
            <div className="game">
             ...
             <div className='mobile__button'>
              ...
              <div className='btn__demo'>
                <a href='https://ssurudisya.github.io/Rock-Paper-Scissor_Game/' target="_blank" rel="noreferrer">Demo</a>
              </div>

              <div className='btn__repo'>
                <a href='https://github.com/SSurudisya/Rock-Paper-Scissor_Game.git' target="_blank" rel="noreferrer">Repo</a>
              </div>
